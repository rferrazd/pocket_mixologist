...
class Profile extends resource_1.default {
    constructor(token, url) {
        super(token, url);
        this.url = `${this.url}/profiles`;
    }
    create(data) {
    ...
    get(profile) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.request.get(`${this.url}/${profile}`, { headers: { Authorization: this.token ? `Bearer ${this.token}` : '' } })
                .then((res) => res.data)
    ...
    update(profile, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.request.patch(`${this.url}/${profile}`, data, { headers: { Authorization: this.token ? `Bearer ${this.token}` : '' } })
    ...
    delete(profile) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.request.delete(`${this.url}/${profile}`, { headers: { Authorization: this.token ? `Bearer ${this.token}` : '' } })
                .then((res) => res.status === 204)
                .catch((err) => { throw new AppError_1.default(err.response.data, err.response.status); });
        });
    }
